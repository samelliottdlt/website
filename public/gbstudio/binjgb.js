var Binjgb = (function () {
  ...
  return function (Binjgb) {
    ...
    var _set_audio_channel_mute = (Module["_set_audio_channel_mute"] =
      function () {
        return (_set_audio_channel_mute = Module["_set_audio_channel_mute"] =
          Module["asm"]["G"]).apply(null, arguments);
      });
    var _joypad_new = (Module["_joypad_new"] = function () {
      return (_joypad_new = Module["_joypad_new"] = Module["asm"]["I"]).apply(
        null,
        arguments,
      );
    });
    ...
    var _rewind_end = (Module["_rewind_end"] = function () {
      return (_rewind_end = Module["_rewind_end"] = Module["asm"]["X"]).apply(
        null,
        arguments,
      );
    });
    var _set_joyp_up = (Module["_set_joyp_up"] = function () {
      return (_set_joyp_up = Module["_set_joyp_up"] = Module["asm"]["Y"]).apply(
        null,
        arguments,
      );
    });
    ...
    var _set_joyp_B = (Module["_set_joyp_B"] = function () {
      return (_set_joyp_B = Module["_set_joyp_B"] = Module["asm"]["aa"]).apply(
        null,
        arguments,
      );
    });
    var _set_joyp_A = (Module["_set_joyp_A"] = function () {
      return (_set_joyp_A = Module["_set_joyp_A"] = Module["asm"]["ba"]).apply(
        null,
        arguments,
      );
    });
